    ...
    public function save(array $data): int
    {
        return $this->database->transaction(function (PDO $pdo) use ($data): int {
            ...
            $fontFields = [
                ...
                'body_font_weight' => (int) ($data['body_font_weight'] ?? 400) ?: 400,
                ...
                'heading_font_weight' => (int) ($data['heading_font_weight'] ?? 600) ?: 600,
                ...
                'menu_font_weight' => (int) ($data['menu_font_weight'] ?? 500) ?: 500,
                ...
                'submenu_font_weight' => (int) ($data['submenu_font_weight'] ?? 500) ?: 500,
