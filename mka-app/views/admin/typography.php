...
<form method="post" action="/admin/typography/save" class="admin-form-stack">
    ...
    <section class="admin-form-card">
        ...
        <div class="admin-form-grid columns-2">
            ...
            <label>
                <span>Grubość fontu treści</span>
                <select name="body_font_weight">
                    <?php foreach ($fontWeights as $weight => $label): ?>
                        <option value="<?= e((string) $weight) ?>" <?= ((int) ($form['body_font_weight'] ?? 400) === $weight) ? 'selected' : '' ?>><?= e($label) ?></option>
                    <?php endforeach; ?>
                </select>
                <?php if (!empty($errors['body_font_weight'])): ?><small class="form-error"><?= e($errors['body_font_weight']) ?></small><?php endif; ?>
            </label>
            <label>
            ...
            <label>
                <span>Grubość fontu nagłówków</span>
                <select name="heading_font_weight">
                    <?php foreach ($fontWeights as $weight => $label): ?>
                        <option value="<?= e((string) $weight) ?>" <?= ((int) ($form['heading_font_weight'] ?? 600) === $weight) ? 'selected' : '' ?>><?= e($label) ?></option>
                    <?php endforeach; ?>
                </select>
                <?php if (!empty($errors['heading_font_weight'])): ?><small class="form-error"><?= e($errors['heading_font_weight']) ?></small><?php endif; ?>
            </label>
            <label>
            ...
            <label>
                <span>Grubość fontu menu głównego</span>
                <select name="menu_font_weight">
                    <?php foreach ($fontWeights as $weight => $label): ?>
                        <option value="<?= e((string) $weight) ?>" <?= ((int) ($form['menu_font_weight'] ?? 500) === $weight) ? 'selected' : '' ?>><?= e($label) ?></option>
                    <?php endforeach; ?>
                </select>
                <?php if (!empty($errors['menu_font_weight'])): ?><small class="form-error"><?= e($errors['menu_font_weight']) ?></small><?php endif; ?>
            </label>
            <label>
            ...
            <label>
                <span>Grubość fontu submenu</span>
                <select name="submenu_font_weight">
                    <?php foreach ($fontWeights as $weight => $label): ?>
                        <option value="<?= e((string) $weight) ?>" <?= ((int) ($form['submenu_font_weight'] ?? 500) === $weight) ? 'selected' : '' ?>><?= e($label) ?></option>
                    <?php endforeach; ?>
                </select>
                <?php if (!empty($errors['submenu_font_weight'])): ?><small class="form-error"><?= e($errors['submenu_font_weight']) ?></small><?php endif; ?>
            </label>
            <label>
