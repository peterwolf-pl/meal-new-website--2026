...
<head>
    ...
    $fontVariables += [
        ...
        '--font-body-weight' => (string) ($settings['body_font_weight'] ?? 400),
        ...
        '--font-heading-weight' => (string) ($settings['heading_font_weight'] ?? 600),
        ...
        '--font-menu-weight' => (string) ($settings['menu_font_weight'] ?? 500),
        ...
        '--font-submenu-weight' => (string) ($settings['submenu_font_weight'] ?? 500),
...
<?= $app->view()->partial('partials/public_header', ['locale' => $locale, 'settings' => $settings, 'navGroups' => $navGroups, 'localeSwitch' => $localeSwitch ?? null]) ?>
<?= $content ?>
